...
// default route
$router->setDefaultRoute('UserApiController', 'showIndex');  
...
$router->addRoute('Home', '', 'UserApiController', 'showIndex');
...
$router->addRoute('Administrador/Productos?sort=prioridad&order=asc', 'GET', 'AdminApiController', 'getProducts'); // Consigna 3 CHECK
